...
// proprio icone de busca no cabecalho).
export default function BuscaFlutuante() {
  ...
  return (
    <Link
      ...
      className="fixed top-3 right-3 z-40 w-10 h-10 flex items-center justify-center bg-[var(--bg-card)] border border-[var(--border)] rounded-full shadow-lg text-[var(--text-secondary)] hover:text-[var(--accent)] active:scale-95 transition-all"
    >
